# Generated by Django 5.1.1 on 2025-04-20 19:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_type', models.CharField(choices=[('text_short', 'Kısa Metin'), ('text_long', 'Paragraf'), ('radio', 'Tek Seçenekli'), ('checkbox', 'Çok Seçenekli'), ('rating', 'Derecelendirme'), ('date', 'Tarih')], max_length=20)),
                ('required', models.BooleanField(default=False)),
                ('order', models.IntegerField(default=0)),
                ('min_rate', models.IntegerField(blank=True, default=1, null=True)),
                ('max_rate', models.IntegerField(blank=True, default=5, null=True)),
            ],
            options={
                'ordering': ['order'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('respondent_id', models.CharField(blank=True, max_length=100)),
